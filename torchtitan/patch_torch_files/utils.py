...
# this file should ideally replace the utils.py file in the torchtitan/distributed repository
# we have already done that for our implementation
...
def create_context_parallel_ctx(
    ...
    if hasattr(cp_mesh, "ndim") and cp_mesh.ndim == 2:
        ...
        # Use standard 1D context parallel for backward compatibility

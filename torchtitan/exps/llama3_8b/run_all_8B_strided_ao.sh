...
DUMP_FOLDER=${DUMP_FOLDER:-"${ROOT_TMP}/run_all_8b_strided_ao"}
BASE_TRACE_FOLDER="run_all_strided_ao"
MEM_BASE_TRACE_FOLDER="run_all_strided_ao"
...
WANDB_PROJECT=${WANDB_PROJECT:-"run_all_8b_strided_ao"}

STEPS=${STEPS:-"5"}
BATCH_SIZE=${BATCH_SIZE:-"1"}

# see Untied-Ulysses/torchtitan/patch_torch_files/checkpoint_wrapper.py
AC_LAYER_STRIDE=${AC_LAYER_STRIDE:-"7"} # setting this to K will skip CPU offloading of the input to every Kth layer

...
DUMP_FOLDER=${DUMP_FOLDER:-"${ROOT_TMP}/v2_mem_isolation_8b_c4"}
BASE_TRACE_FOLDER="v2_mem_isolation_8b_c4"
MEM_BASE_TRACE_FOLDER="v2_mem_isolation_8b_c4"

CONTEXT_LENGTH=${CONTEXT_LENGTH:-"262144"} # 128K
PROFILING_SUFFIX=""
COMPILE=${COMPILE:-"false"}
FLAVOR=${FLAVOR:-"8B"}

# AC/Offloading parameters
OFFLOADING=${OFFLOADING:-"no"} # ["no", "cpu", "UAO", "TAO"] Unsloth/Torchtune offloading
...
WANDB_PROJECT=${WANDB_PROJECT:-"mem_isolation_8b_v2"}
...
ATTN_IMPL_OPTIONS=(
    "upipe_fa3"   # UpipeAttention (Untied Ulysses)
    "usp_fa3"     # LongContextAttention (USP)

    "upipe_fa3_tiled_mlp"   # UpipeAttention (Untied Ulysses)
    "usp_fa3_tiled_mlp"     # LongContextAttention (USP)

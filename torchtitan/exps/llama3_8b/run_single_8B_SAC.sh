...
DUMP_FOLDER=${DUMP_FOLDER:-"${ROOT_TMP}/SAC_exps_8b_v2"}
BASE_TRACE_FOLDER="SAC_exps_8b_v2"
MEM_BASE_TRACE_FOLDER="SAC_exps_8b_v2"

CONTEXT_LENGTH=${CONTEXT_LENGTH:-"524288"} # 512K
PROFILING_SUFFIX="SAC"
...
WANDB_PROJECT=${WANDB_PROJECT:-"SAC_exps_8b"}

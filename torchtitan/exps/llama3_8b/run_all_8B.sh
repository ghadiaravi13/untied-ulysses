...
DUMP_FOLDER=${DUMP_FOLDER:-"${ROOT_TMP}/run_all_8b"}
BASE_TRACE_FOLDER="run_all"
MEM_BASE_TRACE_FOLDER="run_all"
...
WANDB_PROJECT=${WANDB_PROJECT:-"run_all_8b"}
...
METHODS=(
    "upipe upipe_fa3_offload_tiled_mlp 8 1"

...
DUMP_FOLDER=${DUMP_FOLDER:-"${ROOT_TMP}/v2_batch_size_traces_8b_c4"}
BASE_TRACE_FOLDER="v2_batch_size_traces_8b_c4"
MEM_BASE_TRACE_FOLDER="v2_batch_size_traces_8b_c4"

CONTEXT_LENGTH=${CONTEXT_LENGTH:-"131072"} # 128K
PROFILING_SUFFIX=""
...
WANDB_PROJECT=${WANDB_PROJECT:-"batch_size_traces_8b_v2"}

...
RDZV_ENDPOINT=${RDZV_ENDPOINT:-"dev-rghadia-dlraoi:29500"}  # Set this to master node!
...
DUMP_FOLDER=${DUMP_FOLDER:-"${ROOT_TMP}/run_single_multinode_70b"}
BASE_TRACE_FOLDER="run_single_multinode_70b"
MEM_BASE_TRACE_FOLDER="run_single_multinode_70b"
...
WANDB_PROJECT=${WANDB_PROJECT:-"run_single_multinode_70b"}

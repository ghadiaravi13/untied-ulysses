...
def apply_rotary(
    ...
    # CUDA grid Y dimension limit is 65535
    # We need: ceil(seqlen / BLOCK_M) <= 65535, so BLOCK_M >= seqlen / 65535
    CUDA_MAX_GRID_Y = 65535
    BLOCK_M = 8 if rotary_dim <= 128 else 4
    # Increase BLOCK_M if needed to stay within CUDA grid limits

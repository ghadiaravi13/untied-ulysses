...
def _add_training_args(parser):
    ...
    group.add_argument('--use-flash-attn-v3', action='store_true',
                       ...
                       'FlashAttention-3 paper / kernels required')
...
def _add_profiler_args(parser):
    ...
    # Torch profiler arguments (for FPDT tracing)
    group.add_argument("--torch-profiler-enable",
     action='store_true',
     help="Enable PyTorch profiler for generating chrome traces. "
          "Use with --torch-profiler-trace-dir to specify output directory.")
    
    group.add_argument("--torch-profiler-memory-trace",
     action='store_true',
     help="Enable PyTorch profiler memory trace. "
          "Use with --torch-profiler-trace-dir to specify output directory.")

    group.add_argument("--torch-profiler-trace-dir",
     type=str,
     default=None,
     help="Directory to save PyTorch profiler chrome traces. "
          "Each iteration creates a subdirectory with per-rank trace files.")

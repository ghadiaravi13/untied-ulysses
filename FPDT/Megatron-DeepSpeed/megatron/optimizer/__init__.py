...
import os
if get_accelerator().device_name() == 'cuda' and os.environ.get('USE_DS_OPTIM', 'false') == 'false':
    from apex.optimizers import FusedAdam as Adam
    from apex.optimizers import FusedSGD as SGD
elif get_accelerator().device_name() == 'cuda' and os.environ.get('USE_DS_OPTIM', 'false') == 'true':
